...
//        }
  ...
  public ArrayList<Individual> generateRandomProletarians(ArrayList<Individual> population, double[][] cluster) {
      /*
      * Deletes the worst individuals in a population depending on the parameters.proletarian_size and refills the population
      ...
      * */
      ...
      while (current_proletarians < parameters.proletarian_size) {
          Individual proletarian = ea_utils.createRandomIndividual();
